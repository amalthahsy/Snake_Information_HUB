...
def main():
    ...
    selected_page = st.sidebar.selectbox(
        "Select a page",
        ["Snake Identification", "First Aid Video", "Antivenom Hospitals", "Forest Officer Contacts"]
    )
    ...
    if selected_page == "Snake Identification":
        ...
        youtube_video_link = "https://www.youtube.com/watch?v=scEDHsr3APg"
        st.write("Embedding YouTube Video:")
        st.video(youtube_video_link)
        ...
        st.title("Forest Officer Contacts")
        #st.image(Image.open(r'C:'), use_column_width=True)
